...
import aoc2022.Day17Part2.{CrossRock, FallingRock, FlatRock, Point, RockShape, RockStore, computePoints, rockShapes}
...
class Day17Part2Test {
  def newFlatRock(col: Int, row: Long): FallingRock = {
    ...
    FallingRock(shape, location, computePoints(shape, location))
  }
